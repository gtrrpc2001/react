...
import  {eqActions, loginActions}  from '../../components/createslice/createslices';
...
const LoginPage = () =>{
    ...
    function emailChecked(){        
        ...
        setEmailError(emailValid && email.length > 0 ? '' :'올바른 이메일을 입력해주세요.')  
    }
    ...
    const emailEnter = () => {pwdRef.current?.focus()}
    const emailClick = () => {emailRef.current?.focus()}
