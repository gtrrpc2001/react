  ...
  const sleepColor = `${bpmTypeList.sleep ? 'white' : ''}`
    ...
    return (
        <Box sx={{display:'flex',width:'45%',height:25,bgcolor:'#ecf0f3',borderRadius:1,marginLeft:0.5}}>
                ...
                <BpmTypeChildren iconType={'activity'} children={'활동'} 
                bgColor={activitybgColor} Color={activityColor} />                  

                <BpmTypeChildren iconType={'sleep'} children={'수면'} 
                bgColor={sleepbgColor} Color={sleepColor} />                              
