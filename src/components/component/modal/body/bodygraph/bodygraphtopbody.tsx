...
export const BodyGraphTopBody = ({onClick,graphIcon}:Props) => {
    ...
    const buttonStyle = {
        width:width,height:height,border:border,borderColor:borderColor,borderRadius:borderRadius,":hover":hover,
        display:'flex',justifyContent:'center'      
    }
    
    const fontStyle = {fontSize:12,fontWeight:'bold',position:'fixed',top:103}
    const iconStyle = {marginTop:0.3}

    return (
        <Box sx={{height:70,display:'flex'}}>
            <IconBox boxID={"bpm"} onClick={(e)=> onClick(e)} 
            ...
            <IconBox boxID={"pulse"} onClick={(e)=> onClick(e)} 
            ...
            <IconBox boxID={"hrv"} onClick={(e)=> onClick(e)} 
            ...
            <IconBox boxID={"cal"} onClick={(e)=> onClick(e)} 
            ...
            <IconBox boxID={"step"} onClick={(e)=> onClick(e)} 
